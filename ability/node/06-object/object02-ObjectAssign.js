...
console.log('----- undefined & null 情境 希望被預設值替代 但無效 -----------')
const defaultInst = { a: 0, b: 0 }; // 預設值
const srcInst = { a: undefined };
// const srcInst = { a: null };
const destInst = Object.assign({}, defaultInst)
Object.assign(destInst, srcInst)
// Object.assign(srcInst, destInst)
console.log(destInst);
